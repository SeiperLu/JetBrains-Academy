...
class BurgerStore extends BurgerFactory {
    ...
    Burger createBurger(String type) {
        switch (type) {
            case "Chinese":
                return new ChineseBurger("Chinese Burger");/* write your code here */
            case "American":
                return  new AmericanBurger("American Burger");/* write your code here */
            case "Russian":
                return  new RussianBurger("Russian Burger");/* write your code here */
            default:
                return null;
        }
    }
